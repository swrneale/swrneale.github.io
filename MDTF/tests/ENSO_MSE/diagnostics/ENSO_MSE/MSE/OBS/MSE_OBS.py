...
##
prefix = os.environ["POD_HOME"] + "/MSE/OBS"
...
flag0  = 0
##############  check for preprocessed data  from COMPOSITE - 
...
###     plotting routine for all El Nino/La Nina cases 
    generate_ncl_call(os.environ["POD_HOME"]+ "/MSE/OBS/write_netcdf_MSE_composite_OBS.ncl")
