...
print( "Starting ENSO_MSE_OBS.py ") 
...
#     user selectable  domain for MSE variance plots  set in settings.jsonc
#slon1 = "160"
#slon2 = "200"
#slat1 = "-10"
#slat2 =   "+5"
...
#### 1.  COMPOSITE   predigesting OBS data 
